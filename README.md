...
- Создание и редактирование задач через модальное окно в стиле Jira: единый блок пометок слева, большое поле описания и комментарии под задачей.
- В описании задачи доступен Markdown-превью с поддержкой заголовков, списков и блоков кода через ```...```.
- Связи между задачами собраны в компактный блок: можно быстро добавить связь из списка и удалить связь одним кликом.
- Sprint-страница с редактированием статусов и экспортом в CSV.
- Диаграмма Ганта для активных задач с группировкой по исполнителям или по типам.
